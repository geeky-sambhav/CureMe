...
const sendregisterdoctor = require('../../utils/mail');
...
async (req, res) => {
    ...
    try {
        ...
        jwt.sign(payload, process.env.jwtSecret,
            ...
            const message = `Dr ${name} Welcome To CureMe And Congrats For Becoming CureMe Family Memeber
                     
            
            `
            
            
            await sendregisterdoctor({
                email: email,
                subject:`Dr ${name} Welcome To CureMe `,
                message,
            })
