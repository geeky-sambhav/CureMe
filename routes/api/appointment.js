...
const sendappointmentmail = require('../../utils/mail');
...
router.post('/:doctor_id', [authUser,
    ...
    try {
        ...
        const message = `Dr. ${doctor.name} New Appointment Schedule By ${user.name}
        Below Down The Complete Details Of Patient Is Given
        ----------------------------------------------------------------------------
       ...
       -------------------------------------------------------------------------------
        Mail Autogenerated By System Avoid Mistake
        Regards Curefit Team
        ...
        await sendappointmentmail({
            email: doctor.email,
            subject:`Dr ${doctor.name} New Appointment By  ${user.name}`,
            message,
